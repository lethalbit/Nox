...
const char *const dirHostStr = "To Host";
const char *const dirAnalyzerStr = "To Analyzer";
...
static hf_register_info fields[] =
{
	...
	},
	{
		&flags[0],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x0001, NULL, HFILL
		}
	},
	{
		&flags[1],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x0002, NULL, HFILL
		}
	},
	{
		&flags[2],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x0004, NULL, HFILL
		}
	},
	{
		&flags[3],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x0008, NULL, HFILL
		}
	},
	{
		&flags[4],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x0010, NULL, HFILL
		}
	},
	{
		&flags[5],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x0020, NULL, HFILL
		}
	},
	{
		&flags[6],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x0040, NULL, HFILL
		}
	},
	{
		&flags[7],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x0080, NULL, HFILL
		}
	},
	{
		&flags[8],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x0100, NULL, HFILL
		}
	},
	{
		&flags[9],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x0200, NULL, HFILL
		}
	},
	{
		&flags[10],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x0400, NULL, HFILL
		}
	},
	{
		&flags[11],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x0800, NULL, HFILL
		}
	},
	{
		&flags[12],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x1000, NULL, HFILL
		}
	},
	{
		&flags[13],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x2000, NULL, HFILL
		}
	},
	{
		&flags[14],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x4000, NULL, HFILL
		}
	},
	{
		&flags[15],
		{
			...
			FT_BOOLEAN, 1, NULL, 0x8000, NULL, HFILL
		}
	},
	{
		&hfPacketDirection,
